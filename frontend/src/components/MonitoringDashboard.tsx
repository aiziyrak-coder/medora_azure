            ...
            <div>
              ...
              <div className="mb-4 p-4 bg-slate-800/80 border border-slate-600 rounded-lg text-slate-300 text-sm">
                ...
                <ol className="list-decimal list-inside space-y-1.5 text-slate-300">
                  ...
                  <li><strong>Platformada qurilma qo&apos;shish:</strong> <strong>Seriya</strong> = K12_001 (yoki har bir qurilma uchun bitta). <strong>IP va Port</strong> — bo&apos;sh qoldirishingiz mumkin. <strong>Agar jismoniy K12 bitta bo&apos;lsa, platformada ham faqat bitta qurilma qoldiring</strong> — ortiqcha seriyani (masalan K12_01) <strong>O&apos;chirish</strong> orqali olib tashlang; aks holda ma&apos;lumot noto&apos;g&apos;ri qurilmaga ketadi va vitals ko&apos;rinmaydi.</li>
