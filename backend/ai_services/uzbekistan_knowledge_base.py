...
PROTOCOL_DB: list[dict] = [
    {
        ...
        "keywords": ["gipertoniya", "yuqori qon bosim", "AGB", "гипертония", "hypertension", "qon bosimi"],
        "first_line": ["Amlodipin 5-10mg", "Enalapril 10-20mg", "Losartan 50-100mg"],
        "targets": "< 140/90 mmHg (60 yoshdan: < 150/90)",
        "ref": "O'zbekiston SSV buyrug'i №XX (2022) – Arterial Gipertoniya protokoli",
    ...
    },
    {
        ...
        "icd10": ["E11"],
        "keywords": ["qandli diabet", "diabet", "диабет", "diabetes", "CD tip 2", "giperoglikemiya"],
        "first_line": ["Metformin 500-1000mg", "Gliclazid MR 30-60mg"],
        "targets": "HbA1c < 7%; glukoza açliqda 4.4-7.0 mmol/L",
    ...
    },
    {
        ...
        "icd10": ["I21", "I22", "I20"],
        "keywords": ["MI", "yurak xuruj", "infarkt", "инфаркт", "o'tkir koronar", "AKS"],
        "first_line": ["Aspirin 300mg stat", "Klopidogrel", "Heparin", "Statin"],
        "targets": "PCI ≤90 daqiqa maqsad",
    ...
    },
    {
        ...
        "icd10": ["J44"],
        "keywords": ["BOOS", "COPD", "о'pka", "nafas", "yo'tal", "bronxit surunkali"],
    ...
    },
    {
        ...
        "name": "Bronxial Astma",
        "icd10": ["J45", "J46"],
        "keywords": ["astma", "бронхиальная астма", "bronxospazm", "nafas qisilishi"],
    ...
    },
    {
        ...
        "icd10": ["J15", "J18"],
        "keywords": ["pnevmoniya", "o'pka yallig'", "pneumonia", "пневмония"],
        "first_line": [
            "Jamoaviy (mild): Amoksitsillin 0.5g×3",
    ...
    },
    {
        ...
        "icd10": ["N39.0", "N30", "N10"],
        "keywords": ["SYI", "siydik yo'li infeksiya", "tsistit", "pielonefrit", "ИМП", "UTI"],
        "first_line": [
            "Qo'ziqorinli tsistit: Nitrofurantoin 100mg×2×5kun",
            "Og'ir SYI: Siprofloksatsin 500mg×2",
        ],
    ...
    },
    {
        ...
        "icd10": ["K25", "K26"],
        "keywords": ["yara", "gastrit", "meda yara", "oshqozon yara", "H.pylori", "язва"],
    ...
    },
    {
        ...
        "icd10": ["I63", "I61"],
        "keywords": ["insult", "инсульт", "stroke", "ishemik insult", "miya qon aylanishi"],
        "first_line": [
    ...
    },
    {
        ...
        "icd10": ["D50"],
        "keywords": ["anemiya", "анемия", "anemia", "temir tanqisligi", "gemoglobin past", "temir yetishmovchiligi"],
...
QONUNCHILIK:
• "Sog'liqni saqlash to'g'risida" O'zbekiston Respublikasi Qonuni (30.08.1996 №258-I, yangilanishlar bilan)
...
SURGERY_PROTOCOLS: list[dict] = [
    {
        ...
        "steps": [
            ...
            "Toʻliq ovqat iste'mol qilmaslik: kattalarda 6 soat, bolalarda 4 soat",
            "Antibiotik profilaktika: Sefazolin 1-2g operatsiyadan 30 daqiqa oldin",
        ],
        "ref": "O'zR SSV buyrug'i №178 — Preoperativ tayyorgarlik standarti (2022)",
    },
    {
    ...
    },
    {
        ...
        "ref": "O'zR SSV buyrug'i №201 — Postoperativ parvarishlash standarti (2022)",
    },
    {
        ...
        "ref": "O'zR SSV buyrug'i №102 — Infeksion nazorat standarti (2021)",
    },
]
