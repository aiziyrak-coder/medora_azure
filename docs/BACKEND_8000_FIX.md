...
AiDoktorAI backend va frontend **8001** portdan foydalanadi (8000 dan farqli).
...
```powershell
cd E:\AiDoktorai\backend
$env:DJANGO_SETTINGS_MODULE = 'AiDoktorai_backend.settings'
python manage.py runserver 0.0.0.0:8001
```

### 2. Tekshiring

- http://localhost:8001/ → `{"message": "AiDoktorAI Backend API", ...}`
